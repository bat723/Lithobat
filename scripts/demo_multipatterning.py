...
Run from the repository root::
    ...
    python scripts/demo_multipatterning.py

Writes ``results/multipatterning_demo.png``.
...
OUT = Path("results/multipatterning_demo.png")
CUT_OUT = Path("results/sadp_cut_demo.png")


def sadp_cut_demo(optics: OpticsConfig, resist: ResistConfig) -> None:
    ...
    extent = [0, grid.n_pixels * grid.pixel_size * 1e9] * 2
